...
vis_px = 2000
dpi = 250
row_labels = [r'$x$-polarized, epi-detection', r'$y$-polarized, epi-detection', r'$x$-polarized, ortho-detection', r'$y$-polarized, ortho-detection', ]
