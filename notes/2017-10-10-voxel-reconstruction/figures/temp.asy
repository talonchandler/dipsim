    ...
    dot(expi(0.0, 0.0), black);dot(expi(2.99552128518, -0.0082720950691), red);dot(expi(0.141539473324, -3.14159265359), green);
        // Sphere
        ...
        draw(expi(0.0, 0.0)--expi(2.99552128518, -0.0082720950691));dot(Z);shipout(scale(4.0)*currentpicture.fit());