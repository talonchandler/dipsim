...
col_labels = ['Geometry\n($\\alpha_{1}$ = 60${}^{\circ}$, Dose${}_1$/Dose${}_2$ = 10)', r'$\sigma_{\Omega}$ [sr]', 'Mean${}_{0-99}$$\{\sigma_{\Omega}\}$ [sr]', 'STD${}_{0-99}${$\{\sigma_{\Omega}\}$ [sr]']
fig_labels = ['a)', 'b)', 'c)', 'd)']
...
plot_2d_regions(ax2, cax2, pts, mean, special_pt=(dose_rat_plot, alpha1))
plot_2d_regions(ax3, cax3, pts, std, special_pt=(dose_rat_plot, alpha1))
