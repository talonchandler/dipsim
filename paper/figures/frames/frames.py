...
fig = plt.figure(figsize=(4*inch_fig, 1*inch_fig))
gs0 = gridspec.GridSpec(1, 4, wspace=0, hspace=0)
ax0 = plt.subplot(gs0[0])
ax1 = plt.subplot(gs0[1])
ax2 = plt.subplot(gs0[2])
ax3 = plt.subplot(gs0[3])

for ax, fig_label  in zip([ax0, ax1, ax2, ax3], fig_labels):
